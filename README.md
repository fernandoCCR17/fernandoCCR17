<!-- Banner principal -->
<p align="center">
  <img src="./banner.png" alt="Fernando de la Cruz Ramos Banner" width="100%" />
</p>

---

## 👋 Hola, soy Fernando de la Cruz Ramos  
### 💻 Angular · Node.js · C# · SQL Server · React en transición

Full Stack Developer con más de **1 año y 8 meses de experiencia profesional** creando aplicaciones empresariales usando **Angular**, **.NET (C#)**, **Node.js** y **SQL Server**.  
Actualmente me encuentro especializándome en **React y frontend moderno**, desarrollando proyectos personales que integran buenas prácticas, diseño de componentes escalables y enfoque en experiencia de usuario.
Ampliando mi stack hacia herramientas actuales como **Next.js**, **Zustand**, **Tailwind CSS** y más.
...
- [`ToDo Pro`](https://github.com/fernandoCCR17/todo-pro) — App de tareas con login, dashboard y más
- [`Dashboard React + .NET`](https://github.com/fernandoCCR17/react-dashboard) — Fullstack con estadísticas y gráficos
- [`Portfolio`](https://github.com/fernandoCCR17/portfolio) — Web personal con mis proyectos destacados
...
> 🧠 *"Aprender es una constante; construir, una pasión."*  
> Siempre abierto a nuevas oportunidades en entornos colaborativos y desafiantes.
